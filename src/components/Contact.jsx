const socials = [
  { name: 'GitHub', url: 'https://github.com/Raumedeuter', icon: '/icons/github.svg' },
  { name: 'LinkedIn', url: 'http://www.linkedin.com/in/michael-ben-ikheloah-a3324b2a7', icon: '/icons/linkedin.svg' },
  { name: 'Instagram', url: 'https://instagram.com/YOUR_HANDLE', icon: '/icons/instagram.svg' }, // add your real handle
  { name: 'Twitter', url: 'https://twitter.com/YOUR_HANDLE', icon: '/icons/twitter x.svg' }, // add your real handle
  { name: 'Substack', url: 'https://facebook.com/YOUR_HANDLE', icon: '/icons/substack.svg' }, // add your real handle
]
  ...
  return (
    <section id="contact" className="max-w-2xl mx-auto px-6 py-32 text-center scroll-mt-20">
      ...
      <p className="text-neutral-600 mb-10 max-w-md mx-auto">
        I'm currently open to new opportunities — feel free to reach out so we can collaborate.
      </p>
